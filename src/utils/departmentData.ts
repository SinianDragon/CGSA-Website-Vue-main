...
interface Department {
    id: string; // 用来做 URL 路径
    name: string;
    nameEn: string;
    groupPhotoUrl: string; // 部门合照
    photoHeight: string; // 【新增】部门合照的Tspecific高度
    about: string;
...
const departments: Department[] = [
    {
        ...
        groupPhotoUrl: "dept_event.jpg", // 确保这张合照在 src/assets/images/members/
        photoHeight: "800px", // 【修改】你指定的高度
    ...
    },
    {
        ...
        groupPhotoUrl: "dept_admin.jpg", // 确保这张合照在 src/assets/images/members/
        photoHeight: "500px", // 【修改】你指定的高度
    ...
    },
    {
        ...
        groupPhotoUrl: "dept_career.jpg", // 放在 src/assets/images/members/
        photoHeight: "900px", // 【修改】你指定的高度
    ...
    },
    {
        ...
        name: "宣发部",
        nameEn: "Publicity",
        groupPhotoUrl: "dept_publicity.jpg", // 放在 src/assets/images/members/
        photoHeight: "600px", // 【修改】你指定的高度
        ...
        responsibilities: [
            ...
            "内容创作组：负责推文的排版、撰写及原创内容的创作，制作高质量的内容，提升CGSA在各大社交媒体平台的影响力。在你加入在宣发部之后，你将有机会掌握新媒体运营、视觉设计、内容创作、技术开发等多方面的技能，快速提升个人能力，并积累丰富的项目经验。你还将结识志同道K合的伙伴，共同创造精彩内容，展示CGSA的魅力。",
    ...
    },
    {
        ...
        groupPhotoUrl: "dept_bd.jpg", // 放在 src/assets/images/members/
        photoHeight: "700px", // 【修改】你指定的高度
        about: "你是否渴望结交更多志同道合的朋友？你是否想在校园里大展身手，为社团活动带来更多资源和支持？如果你曾梦想过自己能运筹帷幄，决胜千里，或是在各种场合中 V展现才能，那么CGSA外联部正是你的完美舞台。在这里，你可以实现自己的梦想，发挥自己的社交和策略能力，同时学习如何在社会中游刃有余的艺术。",
        responsibilities: [
...
export { getImageUrl, departments };
